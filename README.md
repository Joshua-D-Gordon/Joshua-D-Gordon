...
| Data visualization | This data science project involved multiple parts focused on improving models and analyzing different datasets. Part 1 aimed to improve the previous semester's classification model by implementing an ensemble model (XGBoost) and reducing the feature space. Part 2 focused on the Fashion MNIST dataset, where a simple KNN model was built, and dimensionality reduction techniques (normalization and PCA) were applied. Part 3 explored the Dogs vs. Cats dataset, resizing images, and comparing models before and after PCA. Part 4 focused on hand gesture recognition, preprocessing video data, and training models for accurate predictions. The project demonstrated various data preprocessing, model building, and evaluation techniques.| Python, Pandas, NumPy, Matplotlib, Scikit-learn, XGBoost, Seaborn | [Link to the project repository](https://github.com/Joshua-D-Gordon/Data-visualization) |
